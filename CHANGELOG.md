...
- Support for 10 LLM providers: Anthropic, AWS Bedrock, Azure OpenAI, DeepSeek, Google Gemini, Groq, Mistral, Ollama, OpenAI, xAI
- MCP server connections over stdio, SSE, and Streamable HTTP transports
- Streaming chat with multi-turn history, custom system prompt, and tool activity trace
